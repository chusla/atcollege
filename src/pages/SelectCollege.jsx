...
export default function SelectCollege() {
  ...
  const handleUniversitySearchSelect = async (university) => {
        ...
        >
          ...
          {!showAddUniversity ? (
            <button
              ...
              className="mt-4 w-full flex items-center justify-center gap-2 p-3 rounded-lg border-2 border-dashed border-gray-300 text-gray-500 hover:border-blue-400 hover:text-blue-600 transition-colors"
            >
            ...
            <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg space-y-3">
              ...
              <UniversitySearch
                onSelect={handleUniversitySearchSelect}
